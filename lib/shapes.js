class Shape {
    ...
    RenderShape();
    SetText(){
        return `<text x="50%" y="50%" text-anchor = "middle" font-size = "72" fill="${this.textcolor}">${this.text}</text>`
    };
    RenderSVG();
}
...
class Square extends Shape {
    ...
    RenderSVG() {
        return `<svg width="300" height="200>${this.RenderShape(120)} 
                    ${this.SetText()}
                </svg>`
    }
}
...
class Circle extends Shape {
    ...
    RenderSVG() {
        return `<svg width="300" height="200>${this.RenderShape(80)} 
                    ${this.SetText()}
                </svg>`
    }
}
...
class Triangle extends Shape {
    ...
    RenderSVG() {
        return `<svg width="300" height="200>${this.RenderShape()} 
                    ${this.SetText()}
                </svg>`
    }
}
